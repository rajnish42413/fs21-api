...
var _jsxFileName = "/home/rajnsih/projects/tinycode/fs-21/pages/_app.tsx";
...
if (typeof document !== "undefined") {
  axios__WEBPACK_IMPORTED_MODULE_4___default.a.defaults.baseURL = "http://localhost:3001/api";
  ...
  if (token) {
    axios__WEBPACK_IMPORTED_MODULE_4___default.a.defaults.headers.common['Authorization'] = `${token}`;
  } else {
    axios__WEBPACK_IMPORTED_MODULE_4___default.a.defaults.headers.common['Authorization'] = '';
    delete axios__WEBPACK_IMPORTED_MODULE_4___default.a.defaults.headers.common['Authorization'];
  }
}
...
/* harmony import */ var _auth_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth/reducer */ "./store/auth/reducer.ts");
